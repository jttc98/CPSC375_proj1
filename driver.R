...
model_1 <- lm(Deaths~Confirmed, data = Dem_Beds_Conf)
mode1_2 <- lm(Deaths~(Confirmed+Beds), data = Dem_Beds_Conf)
model_3 <- lm(Deaths~(Confirmed+Beds+POP.TOTAL), data = Dem_Beds_Conf)
model_4 <- lm(Deaths~(Confirmed+Beds+POP.TOTAL + POP.0TO14 + POP.15TO65 + POP.65UP + POP.80UP), data = Dem_Beds_Conf)
model_5 <- lm(Deaths~(Confirmed * Beds), data = Dem_Beds_Conf)
model_6 <- lm(Deaths~(Confirmed * Beds * POP.TOTAL), data = Dem_Beds_Conf)
model_7 <- lm(Deaths~(Confirmed * Beds * POP.TOTAL * POP.0TO14 * POP.15TO65 * POP.65UP * POP.80UP), data = Dem_Beds_Conf)
